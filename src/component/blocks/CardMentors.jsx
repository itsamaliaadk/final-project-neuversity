          ...
          <div className="max-w-sm bg-white border border-blue-950 rounded-lg text-center">
            ...
            <div className="p-5">
              ...
              <div className="flex justify-center gap-3">
                ...
                <button
                  type="button"
                  className="text-white bg-[#222F49] font-medium rounded-full text-sm p-2 px-4 flex items-center py-3"
                  disabled=""
                >
                  <svg
                ...
                <button
                  type="button"
                  className="text-white bg-[#222F49] font-medium rounded-full text-sm p-2 px-4 flex items-center "
                  disabled=""
                >
                  <svg
                    className="w-5 h-5 mr-2"
